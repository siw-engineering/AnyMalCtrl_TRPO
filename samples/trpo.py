...
from UnderdogEnvs.envs.chee_env import CheetahEnv
import gym
import numpy as np
import random
...
def trpo(env_fn:Callable,
         actor_critic=core.MLPActorCritic, 
         ac_kwargs=dict(), seed=0,
         steps_per_epoch=4000, epochs=50, gamma=0.99, delta=0.01, vf_lr=5e-4,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', type=str, default='cheetahPosCtrl-v0')
    ...
    #env1 = gym.make('cheetahAssist-v0', task_cls=CheeFricSpeed, robot_kwargs=robot_kwargs,
    ...
    trpo(lambda: gym.make('cheetahPosCtrl-v0',robot_cls=Robot2, task_cls=Task1, task_kwargs=task_kwargs,robot_kwargs=robot_kwargs), actor_critic=core.MLPActorCritic,
