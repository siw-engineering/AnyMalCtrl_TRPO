...
class StudentEval:
    ...
    def get_observations(self, obs_data_struct: Robot1Obs, *args):
        ...
        return self.noncheat_obs_buffer, obs_info

    def get_observation_space(self):
        robot_obs_space = self.base_task.robot.get_observation_space()
        return Box(np.full((10, 45), robot_obs_space.low),
                   np.full((10, 45), robot_obs_space.high))
